<div class="modal fade" id="addCustodian" tabindex="-1" role="dialog"  aria-hidden="true">
    <form action="{{route('guardians.store')}}" method="post">
        @csrf
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addEquipmentLabel"> اضافة حاضن</h5>
                ...
                <div class="modal-body row" >
                    ...
                    <input name="type" type="hidden" value="حاضن">
                    ...
                    <div class="col-md-6">
                        <label class="form-label required ">مكان اصدار الحضانة</label>
